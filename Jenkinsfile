pipeline {
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/AASAITHAMBI573/Juice-shop-CI-Repo.git'
            }
        }
        ...
        stage('Checkout K8s YAML Repo') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/AASAITHAMBI573/Juice-shop-CD-Repo.git'
            }
        }

        stage('Update helm values.yaml with New Docker Image') {
            environment {
                GIT_REPO_NAME = "Juice-shop-CD-Repo"
            ...
            steps {
                withCredentials([string(credentialsId: 'github-token', variable: 'GITHUB_TOKEN')]) {
                    ...
                    git config user.email "AASAITHAMBI573@example.com"
